...
export class ResolutionService {
    ...
    async TransHashes() {
        ...
        // console.log(rpcProvider.getTransactionReceipt());
        // console.log('===>');
        console.log('hhhh');
        
        const log = await rpcProvider.getTransactionReceipt('0xf137a6ff05c115fa607a4251eb6ad5d7063c076bf69415715207be5ac892b5e1')
        console.log(log);
        console.log('hhhh');
