        ...
        return
            string(
                abi.encodePacked(
                    ...
                    '<text class="c21" transform="translate(16.5 90.08)">',
                    // skills,
                    '</text></g>',
                    '<path data-name="g" class="c26" d="M40 86.42h16.94a.9.9 0 0 1 1 .8V91a.91.91 0 0 1-1 .8H40a.91.91 0 0 1-1-.8v-3.78a.9.9 0 0 1 1-.8Z"/>',
                    '<g class="c20"><text class="c21" transform="translate(40.5 90.08)">',
                    // skills,
                    '</text></g>',
                    '<path class="c26" d="M64 86.42h16.94a.9.9 0 0 1 1 .8V91a.91.91 0 0 1-1 .8H64a.91.91 0 0 1-1-.8v-3.78a.9.9 0 0 1 1-.8Z"/>',
                    '<g data-name="" class="c20"><text class="c21" transform="translate(64.5 90.08)">',
                        // skills,
                    '</text></g>',
