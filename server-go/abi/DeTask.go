...
func (_DeTask *DeTaskCaller) Meta(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _DeTask.contract.Call(opts, &out, "meta")
...
//
// Solidity: function meta() view returns(address)
func (_DeTask *DeTaskSession) Meta() (common.Address, error) {
	return _DeTask.Contract.Meta(&_DeTask.CallOpts)
}

// Meta is a free data retrieval call binding the contract method 0xc885044e.
//
// Solidity: function meta() view returns(address)
func (_DeTask *DeTaskCallerSession) Meta() (common.Address, error) {
	return _DeTask.Contract.Meta(&_DeTask.CallOpts)
}
...
func (_DeTask *DeTaskTransactor) SetMetaContract(opts *bind.TransactOpts, _meta common.Address) (*types.Transaction, error) {
	return _DeTask.contract.Transact(opts, "setMetaContract", _meta)
}

// SetMetaContract is a paid mutator transaction binding the contract method 0x0957a4b6.
//
// Solidity: function setMetaContract(address _meta) returns()
func (_DeTask *DeTaskSession) SetMetaContract(_meta common.Address) (*types.Transaction, error) {
	return _DeTask.Contract.SetMetaContract(&_DeTask.TransactOpts, _meta)
}

// SetMetaContract is a paid mutator transaction binding the contract method 0x0957a4b6.
//
// Solidity: function setMetaContract(address _meta) returns()
func (_DeTask *DeTaskTransactorSession) SetMetaContract(_meta common.Address) (*types.Transaction, error) {
	return _DeTask.Contract.SetMetaContract(&_DeTask.TransactOpts, _meta)
}
