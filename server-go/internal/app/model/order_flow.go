...
type OrderFlow struct {
	...
	OrderId     int64     `gorm:"column:order_id;index:order_id_level" json:"order_id" form:"order_id"`
	Level       int64     `gorm:"column:level;default:1;index:order_id_level" json:"level" form:"level"` // 节点
