...
export default async function insertLog() {
    ...
    //   const CreatProjectEvent = new ethers.utils.Interface(["event CreateProject(address indexed user, uint256 indexed demandId, string title, uint256 budget, string desc, uint256 period)"]);
    //   if (logs.length > 0) {
