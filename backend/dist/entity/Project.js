...
__decorate([
    (0, typeorm_1.Column)("bigint", { name: "pro_id", nullable: true, unique: true }),
    __metadata("design:type", String)
], Project.prototype, "proId", void 0);
__decorate([
...
Project = __decorate([
    ...
    (0, typeorm_1.Index)("project_pro_id_key", ["proId"], { unique: true }),
    (0, typeorm_1.Index)("pro_id", ["proId"], {}),
